...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._setupWrapper = function() {
      ...
      if (this.options.popupTarget) {
        this.popupTarget = $(this.options.popupTarget);
        console.log('new popupTarget:', this.popupTarget);
      } else {
        console.log('default popupTarget:', this.popupTarget);
        this.popupTarget = this.wrapper;
      }
      return this;
    };
    ...
    Annotator.prototype._setupViewer = function() {
      ...
      }).element.appendTo(this.popupTarget).bind({
    ...
    Annotator.prototype._setupEditor = function() {
      ...
      this.editor.element.appendTo(this.popupTarget);
      return this;
    };
    ...
    Annotator.prototype.onHighlightMouseover = function(event) {
      ...
      return this.showViewer(annotations, Util.mousePosition(event, this.popupTarget[0]));
    };
    ...
    Annotator.prototype.onAdderClick = function(event) {
      ...
      position = Util.mousePosition(event, this.popupTarget[0]);
      this.adder.hide();
  ...
  Annotator.Plugin.Store = (function(_super) {
    ...
    Store.prototype.registerAnnotation = function(annotation) {
      ...
      if (this.options.callbacks.create) {
        return this.options.callbacks.create(annotation);
      }
    };

    Store.prototype.unregisterAnnotation = function(annotation) {
      this.annotations.splice(this.annotations.indexOf(annotation), 1);
      if (this.options.callbacks["delete"]) {
        return this.options.callbacks["delete"](annotation);
      }
    };
    ...
    Store.prototype.updateAnnotation = function(annotation, data) {
      ...
      if (this.options.onUpdate) {
        this.options.onUpdate(annotation, data);
      }
      if (this.options.callbacks.update) {
        return this.options.callbacks.update(annotation);
      }
    };
